                     ...
                     showHud:(BOOL)showHud
{
    ...
    WeakSelf
    [HYAFttpTool uploadFileWithParameters:params UrlString:path header:@{} upData:fileModel.data name:@"file" fileName:fileModel.fileName fileType:fileModel.fileType successBlock:^(id responseObject) {
        // 隐藏蒙板
        [Weakself hideHud];
...
//                    // 上传视频
//                    [Weakself uploadFile:imageModel.data params:<#(nonnull NSDictionary *)#> fileName:<#(nonnull NSString *)#> fileType:<#(NSString * _Nullable)#> success:<#^(NSString * _Nullable returnUrl)success#> faile:<#^(void)faile#> showHud:<#(BOOL)#>]
